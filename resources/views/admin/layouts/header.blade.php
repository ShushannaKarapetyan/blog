<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-lg"><b>Interesting</b> Blog</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src={{asset('admin/dist/img/admin_photo.png')}} class="user-image" alt="User Image">
                        <span class="hidden-xs">Shushanna Karapetyan</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                Shushanna Karapetyan - Web Developer
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
